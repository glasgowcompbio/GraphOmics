...
const QUERY_FILTER_EVENT = 4;
const QUERY_FILTER_AND_SELECT_EVENT = 5;

const LAST_CLICKED_FIRDI = 0;
const LAST_CLICKED_CLUSTERGRAMMER = 1;
const LAST_CLICKED_GROUP_MANAGER = 2;
const LAST_CLICKED_QUERY_BUILDER = 3;

const QUERY_BUILDER_WIDTH = '75%';
