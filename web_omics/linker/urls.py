...
urlpatterns = [
    ...
    path('get_swissmodel_protein_pdb/<int:analysis_id>', views.get_swissmodel_protein_pdb, name='get_swissmodel_protein_pdb'),
    path('get_kegg_metabolite_info/<int:analysis_id>', views.get_kegg_metabolite_info, name='get_kegg_metabolite_info'),
    path('get_reactome_reaction_info/<int:analysis_id>', views.get_reactome_reaction_info, name='get_reactome_reaction_info'),
    path('get_reactome_pathway_info/<int:analysis_id>', views.get_reactome_pathway_info, name='get_reactome_pathway_info'),
